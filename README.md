...
## About the project
This is a webapp Chess platform, feauring a single-player mode against a self-programmed AI opponent and real-time online multiplayer gameplay against other users.
